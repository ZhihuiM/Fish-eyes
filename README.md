...
Including RAPiD algorithms about human detection on fisheye images and some traditional algorithms about distortion correction (checkboard, horizontal expansion, latitude, longitude).
